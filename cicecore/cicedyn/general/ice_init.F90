...
! author Elizabeth C. Hunke, LANL
      ...
      namelist /forcing_nml/ &
           ...
           tide_curr_fac, tide_speed_cap, tide_wct_min, tide_wct_full,     &
           tide_h_eff_min, tide_depth_mismatch, tide_ramp_days,            &
...
!         file=__FILE__, line=__LINE__)
      ...
      u_cap                 = 0.0_dbl_kind     !
      u_blend               = 1.0e-3_dbl_kind  ! velocity blending scale for form_func='blend_strain' (m/s)
      ...
      tide_curr_fac       = 1.0_dbl_kind
      tide_speed_cap      = 2.0_dbl_kind
      tide_wct_min        = 20.0_dbl_kind
      tide_wct_full       = 80.0_dbl_kind
      tide_h_eff_min      = 50.0_dbl_kind
      tide_depth_mismatch = 4.0_dbl_kind
      tide_ramp_days      = 20.0_dbl_kind
      ...
      call broadcast_scalar(tide_use_bathymetry_limit, master_task)
      call broadcast_scalar(tide_curr_fac,        master_task)
      call broadcast_scalar(tide_speed_cap,       master_task)
      call broadcast_scalar(tide_wct_min,         master_task)
      call broadcast_scalar(tide_wct_full,        master_task)
      call broadcast_scalar(tide_h_eff_min,       master_task)
      call broadcast_scalar(tide_depth_mismatch,  master_task)
      call broadcast_scalar(tide_ramp_days,       master_task)
